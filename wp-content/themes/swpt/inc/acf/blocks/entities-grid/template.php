...
$entities             = swpt_get_acf_field( 'entities' );
$grid_columns         = swpt_get_acf_field( 'grid_columns' );
$entities_text_align  = swpt_get_acf_field( 'entities_text_align' );
$entities_color       = swpt_get_acf_field( 'entities_color' );
$cta                  = swpt_get_acf_field( 'cta' );
$cta_style            = swpt_get_acf_field( 'cta_style' );
$cta_align            = swpt_get_acf_field( 'cta_align' );
