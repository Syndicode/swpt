...
$fields->addSelect( 'order', array(
	'label'         => __( 'Text/Image order', 'school' ),
	'choices'       => array(
		'text-image' => __( 'Text/Image', 'school' ),
		'image-text' => __( 'Image/Text', 'school' ),
	),
